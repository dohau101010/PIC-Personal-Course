...
void ds18b20_b_ht_lcd()
{
    ...
    {
       ds18b_ngt=ds18b_ng;
       lcd_gm_ht_2so_to_xvn(ds18b_ng,2,0,kx_vn);
       lcd_data(".");
    }
    if(ds18b_tpt!=ds18b_tp)
    {
       ds18b_tpt=ds18b_tp;
       lcd_gm_ht_3so_nho_xvn((ds18b_tp*625)/10,3,7,kx_vn);
    }
}

void ds18b20_b_ht_7doan()
{
    md4l7d_giaima_2so_vitri_vn(ds18b_ng,3,kx_vn);
    xuat_4led_7doan_4so();
}
...
void main()
{
    ...
    while(true)
    {
       ds18b20_b_doc_nhiet_do();
       //so_sanh_nd_dk_buzzer(ds18b_ng);
       delay_ms(200);
