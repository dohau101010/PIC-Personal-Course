...
{
   if(tt) glcd_line(xt, yt, xm_ve, ym_ve,tat);  // xoa hinh phut truoc do
   tinh_vi_tri_kim_phut(bk, tg);   // tinh phut moi
   glcd_line(xt, yt, xs_ve, ys_ve,tat);  // xoa hinh giay truoc do
   //if(tg==59) glcd_line(xt, yt, xm_ve, ym_ve,tat);
}

void glcd_ve_kim_gio(usi8 bk, usi16 tg, int1 tt)
{
   if(tt) glcd_line(xt, yt, xh_ve, yh_ve,tat);  // xoa hinh giay truoc do 
   tinh_vi_tri_kim_gio(bk, tg);   // tinh gio moi
   glcd_line(xt, yt, xs_ve, ys_ve,tat);  // xoa hinh giay truoc do
   glcd_line(xt, yt, xm_ve, ym_ve,tat);  // xoa hinh phut truoc do
   //if(tg==59) glcd_line(xt, yt, xm_ve, ym_ve,tat);
}
